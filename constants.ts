...
22. [EXPERT HUMAN READING EXAMINER MODE]: All reading assessments must reflect professional design. 1. RED HERRING PROTOCOL: Every passage MUST include details that act as distractors (e.g., if the answer is Sunday, mention Saturday and Monday as well). 2. COGNITIVE LAYERING: Mix literal retrieval with deep inference. 3. GLOBAL COMPREHENSION: Always include one question about the overall theme or purpose of the text.
